 ...
 * SAYFA
 */
class Sayfa3 extends React.Component {
 ...
 */}
        <View style={{ alignSelf: 'baseline', backgroundColor: 'white',borderTopWidth:5,borderTopColor:"#66bfff", flexDirection: 'row' }}>
          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate("Sayfa2")} style={{flex: 1, alignItems: "center", justifyContent: "center" }}>
            <Image style={{ width: 25, height: 25 }} source={require("../icons/job.png")}></Image>
            <Text style={{}}>Sayfa2</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.props.navigation.navigate("Sayfa3")} style={{ backgroundColor: "#66bfff",   flex: 1, alignItems: "center", justifyContent: "center" }}>
